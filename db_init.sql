-- 校园助管申请管理平台 数据库初始化脚本
CREATE DATABASE IF NOT EXISTS 3224003048_hst_campus_assist DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE 3224003048_hst_campus_assist;
...
-- 插入测试数据
INSERT INTO users (username, number, password, role, name, email) VALUES
